    ...
    <Drawer open>
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>Insira o seu CPF para listar os pedidos</DrawerDescription>
        </DrawerHeader>
          <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <FormField
              ...
              <DrawerFooter>
                ...
                <DrawerClose>
                  <Button onClick={handleCancel} variant="outline" className="w-full rounded-full">Cancel</Button>
                </DrawerClose>
              </DrawerFooter>
            </form>
          </Form>
